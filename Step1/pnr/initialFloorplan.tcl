...
addRing -spacing {top 2 bottom 2 left 2 right 2} -width {top 3 bottom 3 left 3 right 3}  -layer {top M6 bottom M6 left M5 right M5} -center 1 -type core_rings -nets {VSS  VDD}
